Gem::Specification.new do |s|
  ...
  s.files       = %w[./lib/bare-rb.rb ./lib/types.rb ./lib/exceptions.rb ./lib/lexer.rb ./lib/parser.rb ./lib/generative_testing/gen.rb ./lib/generative_testing/monkey_patch.rb ./lib/generative_testing/grammar_util.rb ]
